...
public enum OutputMessage {
    ...
    HEADER_TOTAL_EVENT_PRICE_HEADER("<총혜택 금액>"),
    ...
    EVENT_NAME_WEEKDAY_EVENT("평일 할인"),
    EVENT_NAME_WEEKEND_EVENT("주말 할인"),
    EVENT_NAME_SEPECIAL_EVENT_EVENT("특별 할인"),
    EVENT_NAME_GIFT_EVENT("증정 이벤트");
